...
public partial class ListenersDialog : GatewayDialog
{
    ...
    private void SetControlStates()
    {
        ...
        {
            this.lblHttpsDescription.Text = "An HTTP listener does not require a certificate.";
        }
        else if (properties.GenerateCertificate && properties.ConfigureWebApp)
        {
            this.lblHttpsDescription.Text = "An HTTPS listener requires a certificate. The self-signed certificate generated by this installer is not trusted by default.";
        }
        else
        {
            this.lblHttpsDescription.Text = "An HTTPS listener requires a certificate. You will be prompted to configure one.";
        }
    }
    ...
    private void PortCheck(object sender)
    {
        ...
        if (string.IsNullOrEmpty(portString) || !Validation.IsValidPort(portString, out uint port))
        {
            result = () =>
            {
                this.ttPortCheck?.SetToolTip(textBox, "Invalid port");
        ...
        else
        {
            ...
            try
            {
                ...
                result = () =>
                {
                    this.ttPortCheck?.SetToolTip(textBox, "The chosen port is available");
            ...
            catch (SocketException se)
            {
                ...
                result = () =>
                {
                    this.ttPortCheck?.SetToolTip(textBox, "The chosen port might not be available");
            ...
            catch
            {
                result = () =>
                {
                    this.ttPortCheck?.SetToolTip(textBox, "The chosen port could not be checked");
                    textBox.ForeColor = SystemColors.WindowText;
                };
            }
            finally
