...
const CLIENT_INFO_BUFFER_UNICODE_WITHOUT_OPTIONAL_FIELDS_LEN: usize = 218;

pub const CLIENT_INFO_BUFFER_UNICODE_LEN: usize = 398;
pub const CLIENT_INFO_BUFFER_UNICODE: [u8; CLIENT_INFO_BUFFER_UNICODE_LEN] = [
...
const CLIENT_INFO_BUFFER_ANSI_LEN: usize = 301;
const CLIENT_INFO_BUFFER_ANSI: [u8; CLIENT_INFO_BUFFER_ANSI_LEN] = [
    0x09, 0x04, 0x09, 0x04, // code page
...
lazy_static! {
    pub static ref CLIENT_INFO_UNICODE: ClientInfo = ClientInfo {
        ...
        credentials: Credentials::new(String::from("eltons"), String::from(""), Some(String::from("NTDEV"))),
    ...
    static ref CLIENT_INFO_ANSI: ClientInfo = {
        let mut client_info = CLIENT_INFO_UNICODE.clone();
        client_info.flags -= ClientInfoFlags::UNICODE;

        client_info
    };
    static ref CLIENT_INFO_UNICODE_WITHOUT_OPTIONAL_FIELDS: ClientInfo = {
        let mut client_info = CLIENT_INFO_UNICODE.clone();
        client_info.extra_info.optional_data = ExtendedClientOptionalInfo::default();

        client_info
    };
    static ref CLIENT_INFO_BUFFER_UNICODE_WITHOUT_OPTIONAL_FIELDS: Vec<u8> = {
