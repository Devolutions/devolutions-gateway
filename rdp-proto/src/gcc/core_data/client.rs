...
impl PduParsing for ClientCoreData {
    ...
    fn from_buffer(mut buffer: impl io::Read) -> Result<Self, Self::Error> {
        let version = RdpVersion::from_u32(buffer.read_u32::<LittleEndian>()?).ok_or(CoreDataError::InvalidVersion)?;
...
impl PduParsing for ClientCoreOptionalData {
    ...
    fn to_buffer(&self, mut buffer: impl io::Write) -> Result<(), Self::Error> {
        try_write_optional!(self.post_beta_color_depth, |value: &ColorDepth| buffer
