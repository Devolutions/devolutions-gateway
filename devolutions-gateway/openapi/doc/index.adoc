...
* *Bearer* Authentication `enrollment_token`
...
`DELETE /jet/tunnel/agents/{agent_id}`
...
// markup not found, no include::{specDir}jet/tunnel/agents/\{agent_id\}/DELETE/spec.adoc[opts=optional]
...
// markup not found, no include::{specDir}jet/tunnel/agents/\{agent_id\}/DELETE/implementation.adoc[opts=optional]
...
// markup not found, no include::{specDir}jet/tunnel/enroll/POST/spec.adoc[opts=optional]
...
| EnrollRequest
| Agent identity and certificate signing request <<EnrollRequest>>
| X
| 
| 
...
| 400
| Invalid agent name, request body, or certificate signing request
|  <<>>


| 401
| Invalid or missing enrollment token
|  <<>>


| 409
| Agent ID or name already registered, agent key previously deleted, or enrollment token already used
|  <<>>
...
// markup not found, no include::{specDir}jet/tunnel/enroll/POST/implementation.adoc[opts=optional]
...
`GET /jet/tunnel/agents/{agent_id}`
...
// markup not found, no include::{specDir}jet/tunnel/agents/\{agent_id\}/GET/spec.adoc[opts=optional]
...
// markup not found, no include::{specDir}jet/tunnel/agents/\{agent_id\}/GET/implementation.adoc[opts=optional]
...
// markup not found, no include::{specDir}jet/tunnel/agents/GET/spec.adoc[opts=optional]
...
| 200
| Accepted agents and their current status
| List[<<AgentInfo>>] 
...
// markup not found, no include::{specDir}jet/tunnel/agents/GET/implementation.adoc[opts=optional]
...
// markup not found, no include::{specDir}jet/jrec/search/POST/spec.adoc[opts=optional]
...
| JSON-encoded search request <<RecordingLogSearchRequest>>
| X
| 
| 
...
| 413
| Too many recording IDs in one request
|  <<>>
...
// markup not found, no include::{specDir}jet/jrec/search/POST/implementation.adoc[opts=optional]
...
=== _AgentDomainAdvertisement_ 




[.fields-AgentDomainAdvertisement]
[cols="2,1,1,2,4,1"]
|===
| Field Name| Required| Nullable | Type| Description | Format
...
| 
| X
|   List   of <<AgentDomainAdvertisement>>
...
[#RecordingLogSearchField]
=== _RecordingLogSearchField_ 
...
[.fields-RecordingLogSearchField]
[cols="1"]
|===
| Enum Values
...
[#RecordingLogSearchHit]
=== _RecordingLogSearchHit_ 

One Session Recording Log entry matching the search


[.fields-RecordingLogSearchHit]
[cols="2,1,1,2,4,1"]
|===
| Field Name| Required| Nullable | Type| Description | Format
...
| X
| 
|   List   of <<RecordingLogSearchField>>
...
[#RecordingLogSearchRequest]
=== _RecordingLogSearchRequest_ 

Session Recording Log search request


[.fields-RecordingLogSearchRequest]
[cols="2,1,1,2,4,1"]
|===
| Field Name| Required| Nullable | Type| Description | Format
...
[#RecordingLogSearchResponse]
=== _RecordingLogSearchResponse_ 

Session Recording Log search result


[.fields-RecordingLogSearchResponse]
[cols="2,1,1,2,4,1"]
|===
| Field Name| Required| Nullable | Type| Description | Format
