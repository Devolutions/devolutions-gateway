...
namespace Devolutions.Gateway.Client.Model
{
    ...
    /// ClaimedTrafficEvent
    /// </summary>
    [DataContract(Name = "ClaimedTrafficEvent")]
    public partial class ClaimedTrafficEvent : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClaimedTrafficEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClaimedTrafficEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ClaimedTrafficEvent" /> class.
        /// </summary>
        ...
        public ClaimedTrafficEvent(long activeDurationMs = default(long), long bytesRx = default(long), long bytesTx = default(long), long connectAtMs = default(long), long disconnectAtMs = default(long), EventOutcomeResponse outcome = default(EventOutcomeResponse), TransportProtocolResponse protocol = default(TransportProtocolResponse), Guid sessionId = default(Guid), string targetHost = default(string), string targetIp = default(string), int targetPort = default(int), string id = default(string))
        {
            ...
            if (targetHost == null)
            {
                throw new ArgumentNullException("targetHost is a required property for ClaimedTrafficEvent and cannot be null");
            }
            this.TargetHost = targetHost;
            // to ensure "targetIp" is required (not null)
            if (targetIp == null)
            {
                throw new ArgumentNullException("targetIp is a required property for ClaimedTrafficEvent and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClaimedTrafficEvent {\n");
