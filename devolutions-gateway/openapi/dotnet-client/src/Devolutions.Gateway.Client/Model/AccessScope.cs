...
namespace Devolutions.Gateway.Client.Model
{
    ...
    public enum AccessScope
    {
        ...
        /// <summary>
        /// Enum GatewayUpdateRead for value: gateway.update.read
        /// </summary>
        [EnumMember(Value = "gateway.update.read")]
        GatewayUpdateRead = 12,
        ...
        GatewayTrafficClaim = 14,

        /// <summary>
        /// Enum GatewayTrafficAck for value: gateway.traffic.ack
        /// </summary>
        [EnumMember(Value = "gateway.traffic.ack")]
        GatewayTrafficAck = 15,

        /// <summary>
        /// Enum GatewayNetMonitorConfig for value: gateway.net.monitor.config
        /// </summary>
        [EnumMember(Value = "gateway.net.monitor.config")]
        GatewayNetMonitorConfig = 16,

        /// <summary>
        /// Enum GatewayNetMonitorDrain for value: gateway.net.monitor.drain
        /// </summary>
        [EnumMember(Value = "gateway.net.monitor.drain")]
        GatewayNetMonitorDrain = 17,

        /// <summary>
        /// Enum GatewayAgentDelete for value: gateway.agent.delete
        /// </summary>
        [EnumMember(Value = "gateway.agent.delete")]
        GatewayAgentDelete = 18,
    ...
    public static class AccessScopeExtensions
    {
        ...
        public static string ToValue(this AccessScope variant)
        {
            switch (variant)
            {
                ...
                case AccessScope.GatewayUpdateRead:
                    return "gateway.update.read";
                ...
                case AccessScope.GatewayNetMonitorConfig:
                    return "gateway.net.monitor.config";
                case AccessScope.GatewayNetMonitorDrain:
                    return "gateway.net.monitor.drain";
                case AccessScope.GatewayAgentDelete:
