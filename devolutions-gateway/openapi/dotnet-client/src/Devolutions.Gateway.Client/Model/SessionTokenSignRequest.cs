...
namespace Devolutions.Gateway.Client.Model
{
    ...
    public partial class SessionTokenSignRequest : IValidatableObject
    {
        ...
        public SessionTokenSignRequest(SessionTokenContentType contentType = default, string destination = default, string krbKdc = default, string krbRealm = default, long lifetime = default, string protocol = default, Guid? sessionId = default)
        {
