...
namespace Devolutions.Gateway.Client.Model
{
    ...
    public partial class SessionTokenSignRequest : IEquatable<SessionTokenSignRequest>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as SessionTokenSignRequest);
        }

        /// <summary>
        /// Returns true if SessionTokenSignRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionTokenSignRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionTokenSignRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.KrbKdc == input.KrbKdc ||
                    (this.KrbKdc != null &&
                    this.KrbKdc.Equals(input.KrbKdc))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.KrbKdc != null)
                {
                    hashCode = (hashCode * 59) + this.KrbKdc.GetHashCode();
                }
