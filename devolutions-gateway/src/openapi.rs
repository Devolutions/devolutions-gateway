...
#[openapi(
    ...
    components(schemas(
        ...
        crate::api::net::Probe,
        network_scanner::results::NetworkScanResultEvent,
        network_scanner::results::NetworkScanResultKind,
        network_scanner::results::ScanResultSource,
        network_scanner::results::HostScanState,
