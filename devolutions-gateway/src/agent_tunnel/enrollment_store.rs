...
mod tests {
    ...
    fn expired_token_not_consumable() {
        ...
        assert!(!store.redeem("expired-tok"));
    }
    ...
    fn cleanup_removes_expired() {
        ...
        assert!(!store.redeem("expired"));
        assert!(store.redeem("valid"));
    }
}
