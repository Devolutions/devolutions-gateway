...
pub struct PacketsParsingApi<'a> {
    ...
    NowWaykPacketsParsing_GetSize: Symbol<'a,unsafe extern "C" fn(ctx: NowPacketsParsing, width: *mut u32, height: *mut u32)>,
    NowWaykPacketsParsing_ParseMessage: Symbol<'a,unsafe extern "C" fn(ctx: NowPacketsParsing, buffer: *const u8, len: usize, messageType: *mut u32, isFromServer: bool) -> usize>,
    NowWaykPacketsParsing_GetImageBuff: Symbol<'a,unsafe extern "C" fn(ctx: NowPacketsParsing, updateX: *mut u32, updateY: *mut u32, updateWidth: *mut u32, updateHeight: *mut u32, surfaceStep: *mut u32, surfaceSize: *mut u32) -> *mut u8>,
...
impl PacketsParser {
    ...
    pub fn new(lib: Arc<Library>) -> Self {
        ...
        let ctx = unsafe {
            (api.NowWaykPacketsParsing_CreateParsingContext)()
        };
    ...
    pub fn parse_message(&self, buffer: &[u8], len: usize, is_from_server: bool) -> (usize,u32) {
        unsafe {
            ...
            let res = (self.api.NowWaykPacketsParsing_ParseMessage)(self.ctx, buffer.as_ptr(), len, (&mut message_id) as *mut u32, is_from_server);
            (res, message_id)
        }
    }
    ...
    pub fn is_message_constructed(&self) -> bool {
        unsafe {
            (self.api.NowWaykPacketsParsing_IsMessageConstructed)(self.ctx)
        }
    }
    ...
    pub fn get_image_data(&self) -> ImageUpdate {
        unsafe {
            ...
            let ptr: *const u8 = (self.api.NowWaykPacketsParsing_GetImageBuff)(self.ctx, (&mut update_x) as *mut u32, (&mut update_y) as *mut u32,
                                                         (&mut update_width) as *mut u32, (&mut update_height) as *mut u32, (&mut surface_step) as *mut u32, (&mut surface_size) as *mut u32);
