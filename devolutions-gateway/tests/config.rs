...
fn sample_2() -> Sample {
    Sample {
        ...
        file_conf: ConfFile {
            ...
            tls_certificate_file: Some("/path/to/tls-certificate.pem".into()),
            tls_private_key_file: Some("/path/to/tls-private.key".into()),
            use_windows_certificate_store: Some(true),
            windows_certificate_store_type: Some(WindowsCertStoreType::LocalMachine),
            windows_certificate_store_name: Some("my".to_owned()),
            listeners: vec![],
            subscriber: None,
