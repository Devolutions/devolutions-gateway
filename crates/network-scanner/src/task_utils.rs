...
pub fn clone3<A, B, C>(a: &A, b: &B, c: &C) -> (A, B, C)
where
    A: Clone,
    B: Clone,
    C: Clone,
...
pub fn clone4<A, B, C, D>(a: &A, b: &B, c: &C, d: &D) -> (A, B, C, D)
where
    A: Clone,
    B: Clone,
    C: Clone,
...
pub fn clone5<A, B, C, D, E>(a: &A, b: &B, c: &C, d: &D, e: &E) -> (A, B, C, D, E)
where
    A: Clone,
    B: Clone,
    C: Clone,
