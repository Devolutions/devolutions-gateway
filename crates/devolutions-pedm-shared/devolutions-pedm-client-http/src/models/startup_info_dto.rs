...
impl StartupInfoDto {
    pub fn new(fill_attribute: u32, flags: u32, parent_pid: u32, show_window: u32, x: u32, x_count_chars: u32, x_size: u32, y: u32, y_count_chars: u32, y_size: u32) -> StartupInfoDto {
        StartupInfoDto {
            desktop: None,
            fill_attribute,
            flags,
