...
pub trait DefaultApi {
    ...
    fn elevate_temporary_post(&self, elevate_temporary_payload: models::ElevateTemporaryPayload) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn launch_post(&self, launch_payload: models::LaunchPayload) -> Pin<Box<dyn Future<Output = Result<models::LaunchResponse, Error>>>>;
    ...
    fn policy_assignments_id_put(&self, id: &str, user: Vec<models::User>) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    ...
    fn policy_profiles_id_put(&self, id: &str, profile: models::Profile) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
...
impl<C: hyper::client::connect::Connect>DefaultApi for DefaultApiClient<C>
    ...
    #[allow(unused_mut)]
    fn policy_rules_get(&self, ) -> Pin<Box<dyn Future<Output = Result<Vec<String>, Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::GET, "/policy/rules".to_string())
        ;
