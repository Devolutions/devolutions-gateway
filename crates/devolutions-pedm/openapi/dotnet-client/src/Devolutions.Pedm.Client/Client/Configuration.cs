...
namespace Devolutions.Pedm.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "2024.12.16";
        ...
        public static readonly ExceptionFactory DefaultExceptionFactory = (methodName, response) =>
        {
            ...
            if (status >= 400)
            {
                return new ApiException(status,
                    string.Format("Error calling {0}: HTTP status code {1}", methodName, status),
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/2024.12.16/csharp");
        ...
        {
            string report = "C# SDK (Devolutions.Pedm.Client) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: \n";
            report += "    SDK Package Version: 2024.12.16\n";
