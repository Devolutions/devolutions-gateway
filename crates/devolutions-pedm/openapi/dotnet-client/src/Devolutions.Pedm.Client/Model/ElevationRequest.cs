...
namespace Devolutions.Pedm.Client.Model
{
    ...
    public partial class ElevationRequest : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for UnixTimestampSeconds, must be a value greater than or equal to 0.", new [] { "UnixTimestampSeconds" });
            }
