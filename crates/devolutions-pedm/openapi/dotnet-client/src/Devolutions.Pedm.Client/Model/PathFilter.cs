...
namespace Devolutions.Pedm.Client.Model
{
    ...
    /// PathFilter
    /// </summary>
    [DataContract(Name = "PathFilter")]
    public partial class PathFilter : IValidatableObject
    {
        ...
        public PathFilterKind Kind { get; set; }
        /// <summary>
        ...
        public PathFilter(string data = default(string), PathFilterKind kind = default(PathFilterKind))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for PathFilter and cannot be null");
            }
            this.Data = data;
            this.Kind = kind;
        }
